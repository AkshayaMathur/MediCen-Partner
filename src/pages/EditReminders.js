...
import {formatDate, formateDate} from '../utils/date.formatter';
...
class EditReminders extends Component {
  ...
  constructor(props) {
    super(props);
    console.log(props.route.params.reminderDetails);
    const details = props.route.params.reminderDetails;
    this.state.Id = details.Id;
    this.state.frequency = details.frequency;
    this.state.dayFrequency = details.dayFrequency;
    this.state.dayFrequencyTime = details.dayFrequencyTime;
    this.state.message = details.message;
    this.state.expiryDate = details.expiryDate;
    // moment(details.expiryDate).format('YYYY MM DD');
    console.log(moment(details.expiryDate).format('YYYY-MM-DD'));
  }
